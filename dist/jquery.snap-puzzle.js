...
(function (global, factory) {
    ...
    var SnapPuzzlePiece = /** @class */ (function () {
         ...
         */
        SnapPuzzlePiece.prototype.solve = function (options) {
            var _this = this;
                ...
                this.pieceEl.position({
                    ...
                    using: function (position, data) {
                        ...
                        _this.pieceEl.animate({
                            top: position.top,
                            left: position.left
                        }, options.animate != false ? Math.min(2000, distance * 2) : 0, function () {
    ...
    var SnapPuzzleGame = /** @class */ (function () {
         ...
         */
        SnapPuzzleGame.prototype.solve = function (resolveAllOrIndex, options) {
        ...
        SnapPuzzleGame.prototype._construct = function () {
            ...
            if (this.options.hints && this.options.hints > 0) {
                for (var i = 0; i < this.options.hints; i++) {
